...
const Profile = () => {
  ...
  useEffect(() => {
    // when this page loads all the data of users gets fetched from the Db
    const getData = async () => {
  ...
  // to follow any profile this function will be trigred to follow ay users
  ...
  // this function will be trigred when we unfollow any user any it removew the user from firebas db of the propfile
